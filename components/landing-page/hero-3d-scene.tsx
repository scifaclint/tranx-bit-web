...
function Scene() {
  ...
  return (
    <>
      ...
      {/* Removed extra pointLight to reduce GPU load */}

      <Environment preset="apartment" intensity={isDark ? 0.3 : 0.2} />
      ...
      {/* 3. FOREGROUND accents: Currency Symbols - Only on desktop */}
      {!isMobile && (
        <>
          <FloatingSymbol
            position={[-3, 3, 1]}
      ...
      {/* Post Processing */}
      {/* Bloom effect disabled for performance - use CSS glow instead */}
      {/* <EffectComposer>
                <Bloom
  ...
  return (
    <div className="absolute inset-0 w-full h-full">
      <Canvas
        ...
        performance={{ min: 0.5, max: 0.75 }}
      >
        <fog
          attach="fog"
          args={[theme === "dark" ? "#020617" : "#ffffff", 5, 25]}
        />
