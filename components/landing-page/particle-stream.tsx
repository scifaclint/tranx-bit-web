...
export function ParticleStream() {
    ...
    // Configuration
    const count = 600; // More particles for wider area
    ...
    useFrame((state) => {
        ...
        particles.forEach((particle, i) => {
            ...
            const scale = Math.sin(time * 0.2 + i) * 0.1 + 0.9; // Very subtle, slow breath
    ...
    return (
        <instancedMesh ref={meshRef} args={[undefined, undefined, count]}>
            <dodecahedronGeometry args={[particleSize, 0]} /> {/* Diamond/Gem shape */}
