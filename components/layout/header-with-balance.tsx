  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-6 sm:mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="bg-backgroundSecondary shadow-sm rounded-2xl">
          ...
          <CardFooter className="pt-4">
            <div className="w-full border-t border-gray-100 pt-4">
              <Button
                ...
                className="w-full justify-center border-black text-black hover:text-blue-600 transition-colors focus-visible:ring-2 focus-visible:ring-black/20"
                variant="outline"
        ...
        {/* Ads Carousel */}
        <Card className="bg-backgroundSecondary rounded-2xl p-4 shadow-lg border border-gray-200">
          <div className="space-y-3">
